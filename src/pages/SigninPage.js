    ...
    function getLoginOrSignUpPage() {
        return (
            <>
                ...
                />
                <Button class="button-style" id="sign-in-button" variant="contained" onClick={signInHandler}>
                    Continue
                </Button>
            </>
        );
    ...
    function getCodeVerificationPage() {
        return (
            <>
                ...
                />
                <Button class="button-style" id="sign-in-button" variant="contained" onClick={codeConfirmedHandler}>
                    Confirm
                </Button>
            </>
        );
